...
class rTextTheme{
  ...
  static TextTheme lightTextTheme=TextTheme(
    ...
    labelMedium: TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.w600,color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextTheme=TextTheme(
    ...
    labelMedium: TextStyle().copyWith(fontSize: 12.0,fontWeight: FontWeight.w600,color: Colors.white.withOpacity(0.5)),
  );
